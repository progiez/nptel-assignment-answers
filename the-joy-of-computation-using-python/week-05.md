# NPTEL The Joy Of Computation Using Python Week 05 Assignment Answers
...
![The Joy of Computing Using Python NPTEL Week 5 Answers (July-Dec 2024)](https://miro.medium.com/v2/resize:fit:875/1*P1JOcynPtprTQh4w9xjp5A.jpeg)
...
**Answer:** [Click here to view Answers](https://progiez.com/the-joy-of-computing-using-python-nptel-week-5-answers)
...
**3. What should be replaced with ? in line 10, so that there is high chance that final\_choice is equal to 2?**
...
**Course Link:** [**Click Here**](https://onlinecourses.nptel.ac.in/noc24_cs57/preview)
...
**Write a function named final that accepts a positive integer _**n**_ and a sequence of moves (string) as arguments and returns the final position where you would end up in an _**n**_×_**n**_ grid-world if you start at (1,1). You must return a tuple of size 2, where the first element is the x-coordinate and the second is the y-coordinate.\
