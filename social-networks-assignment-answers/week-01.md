# NPTEL Social Networks Assignment Answers Week 01 Assignment Answers
...
![Social Networks Nptel Week 1 Assignment Answer and solution Swayam Platform image](https://progiez.com/wp-content/uploads/2023/07/Social-Networks-Nptel-Week-1-Assignment-Answer-and-solution-Swayam-Platform-image-1024x576.webp "Social Networks Week 1 Nptel Assignment Answers 1")
...
- **(c)** A scatter plot with points `(1, 1)`, `(2, 4)`, `(3, 9)`, `(4, 16)`.
- **(d)** A histogram displaying the values of `x` and `y`.
...
**6. In a social network, you are tasked with finding the shortest path between two individuals, `A` and `B`. Which of the following algorithms would be suitable?**
...
[****See also**  **Social Networks | Week 11****](https://progiez.com/nptel-social-networks-week-11-assignment-11-answers)
...
- **(b)** `nx.jaccard_coefficient(G)`
- **(c)** `nx.adamic_adar_index(G)`
- **(d)** `nx.preferential_attachment(G)`
...
## __Nptel Social Networks Week 1 Assignment Answers_ _(J_ul-Dec 2024_)__

**Course Link: [**Click Here**](https://onlinecourses.nptel.ac.in/noc23_cs107/course)**
...
[****See also**  **Social Networks | Week 8****](https://progiez.com/nptel-social-networks-week-8-assignment-8-answers)
...
**Q10. In the command networkx.erdos\_renyi\_graph(a,b), the parameters ‘a’ and ‘b’ denote the following respectively:**\
...
## _Nptel Social Networks Week 1 Assignment Answers_ _(Jan-Apr 2023)_
...
G=nx.Graph()\
G.add\_nodes\_from(\[i for i in range(10)])**
...
**Q6) Which of the statements is True for the graph created from the statement: nx.gnp\_random\_graph(10,0.5)?**\
